...
def get_target_features(data):
    ...
    # Target: Predicting tomorrow's price change
...
# Left Sidebar for ticker input and date range selection
...
<h2 style="font-size: 18px; font-weight: bold; color: red;">-  Decision Tree Classifier (Entropy)</h2>
